                ...
                <div className='flex w-full h-[80%] bg-[#F1F1F1] rounded-2xl rounded-t-none dark:border dark:border-black'>
                    <form className='w-[83%] ml-[8%] mt-[3%] mb-[2%]'>
                        <div className='mb-[3%]'>
                            ...
                            <input type='text' className='w-[100%] p-4 pl-5 rounded-[15px] bg-[#FAFAFA] placeholder-gray-500 placeholder:font-bold font-bold border-[#FFB703] border-2 dark:border-black' placeholder="Enter Task Title" ></input>
                        </div>
                        <div className='mb-[2%]'>
                            <div className='flex mb-2'>
                        ...
                        <div className='flex justify-end'>
                            <button className="bg-[#D6D6D6] text-[#023047] text-2xl font-bold py-2.5 px-2.5 rounded-[3px] dark:border-black dark:bg-white dark:text-black
                                               hover:bg-[#b0b0b0] hover:text-[#00314a] transition-colors delay-250 duration-[3000] ease-in" onClick={()=> onCancel()}>Cancel</button>
                            <button type="submit" className="text-white ml-[3%] bg-[#FB8500] font-semibold py-2.5 px-6 rounded-[3px] dark:bg-black
                                                            hover:bg-[#FF9925] transition-colors delay-250 duration-[3000] ease-in" onClick={()=> onCancel()}>Save</button>
                        </div>
